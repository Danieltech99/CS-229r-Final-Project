...
class SpecifyLargeLeverage(SpecifySmallLeverage):
    ...
    def calculate_leverage(self,g,u,v):
        return leverage_score(g,u,v)
    ...
    def find_max_edge(self, g, target, current, bound,allow_disconnected):
        ...
        in_range = [(f, g, self.calculate_leverage(g,u,v)) for (f, g, (u,v)) in in_range]
